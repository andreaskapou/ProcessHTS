#' Wrapper method for processing Beatson RNA-Seq and BS-Seq HTS data
#'
...
#' #data <- process_beatson_wrap(bs_file, rna_file)
#'
#' @export
process_beatson_wrap <- function(bs_files, rna_files, chrom_size_file = NULL,
